...
{
	/// <summary>Class which represents the entity 'AddressSimple', mapped on table 'LLBLGenProUnitTest.dbo.Address'.</summary>
	public partial class AddressSimple : INotifyPropertyChanging, INotifyPropertyChanged
	{
		#region Events
		...
		/// <summary>Initializes a new instance of the <see cref="AddressSimple"/> class.</summary>
