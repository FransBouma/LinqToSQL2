...
{
	/// <summary>
	/// Class which produces SqlNodes for DbEngine specific elements so SQL can be created tailored to the needs of a given DbEngine.
	/// </summary>
	internal class NodeFactory
	{
		...
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallStringLength(SqlExpression expr)
		{
			return expr;
		}
		...
		/// <param name="expr">The expr.</param>
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallDataLength(SqlExpression expr)
		{
			return expr;
		}
		...
		/// <param name="expr">The expr.</param>
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallChrLength(SqlExpression expr)
		{
			return expr;
		}
		...
		/// <param name="expr">The expr.</param>
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallDatePart(string partName, SqlExpression expr)
		{
			return expr;
		}
		...
		/// <param name="expr">The expr.</param>
		/// <returns></returns>
		internal SqlExpression FunctionCallDateAdd(string partName, SqlExpression value, SqlExpression expr)
		{
			return FunctionCallDateAdd(partName, value, expr, expr.SourceExpression, false);
		}
		...
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallDateAdd(string partName, SqlExpression value, SqlExpression expr, Expression sourceExpression, bool asNullable)
		{
			return expr;
		}
		...
		/// <param name="expr">The expr.</param>
		/// <returns></returns>
		internal SqlExpression FunctionCallDateTimeOffsetAdd(string partName, SqlExpression value, SqlExpression expr)
		{
			return FunctionCallDateTimeOffsetAdd(partName, value, expr, expr.SourceExpression, false);
		}
		...
		/// <param name="asNullable">if set to <c>true</c> [as nullable].</param>
		/// <returns></returns>
		internal virtual SqlExpression FunctionCallDateTimeOffsetAdd(string partName, SqlExpression value, SqlExpression expr, Expression sourceExpression, bool asNullable)
		{
			return expr;
		}
		...
		/// <returns></returns>
		internal virtual bool IsDateTimeType(SqlExpression exp)
		{
			return false;
		}
		...
		/// <param name="exp">The exp.</param>
		/// <returns></returns>
		internal virtual bool IsDateType(SqlExpression exp)
		{
			return false;
		}
		...
		/// <param name="exp">The exp.</param>
		/// <returns></returns>
		internal virtual bool IsTimeType(SqlExpression exp)
		{
			return false;
		}
		...
		/// <param name="exp">The exp.</param>
		/// <returns></returns>
		internal virtual bool IsDateTimeOffsetType(SqlExpression exp)
		{
			return false;
		}
		...
		/// <param name="exp">The exp.</param>
		/// <returns></returns>
		internal virtual bool IsHighPrecisionDateTimeType(SqlExpression exp)
		{
			return false;
		}
		...
		{
			return this.IsTimeType(exp) ? ConvertToDouble(exp) : exp;
		}
		...
		internal virtual SqlExpression AddTimeSpan(SqlExpression dateTime, SqlExpression timeSpan, bool asNullable)
		{
			return dateTime;
		}
