...
{
#warning REFACTOR: STILL SQL SERVER SPECIFIC. Can't be refactored now, core needs addition of dbspecific generator object to produce db specific elements

	/////////////////////////////////////////////////////////////////////////////////////////////
	/// 
	/// This class is left in common while it's SQL Server specific, because to refactor away this
	/// dependency, a db specific generator object has to be introduced which takes over the role of this
	/// class to produce quotes, aliases etc. 
	/// 
	/////////////////////////////////////////////////////////////////////////////////////////////
